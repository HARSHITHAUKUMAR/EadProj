...
PrintWriter pw = response.getWriter();
			...
			try {
				...
				pst = con.prepareStatement("select f.fname,f.specialization,f.phonenum,f.email,c.collname from faculty f,college c where c.collid=f.collid and c.collname=?");
				pst.setString(1, collname);
				rs = pst.executeQuery();
				
				if(collname.equalsIgnoreCase(collname)){
				while (rs.next())
				{
